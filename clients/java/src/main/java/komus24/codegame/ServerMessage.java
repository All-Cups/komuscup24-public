...
public abstract class ServerMessage {
    ...
    public static class UpdateConstants extends ServerMessage {
         ...
         * New constants
         */
        private komus24.model.Constants constants;
    
        /**
         * New constants
         */
        public komus24.model.Constants getConstants() {
            return constants;
        }
         ...
         * New constants
         */
        public void setConstants(komus24.model.Constants value) {
            this.constants = value;
        }
    
        public UpdateConstants(komus24.model.Constants constants) {
        ...
        public static UpdateConstants readFrom(java.io.InputStream stream) throws java.io.IOException {
            komus24.model.Constants constants;
            constants = komus24.model.Constants.readFrom(stream);
    ...
    public static class GetOrder extends ServerMessage {
         ...
         * Player's view
         */
        private komus24.model.PlayerView playerView;
    
        /**
         * Player's view
         */
        public komus24.model.PlayerView getPlayerView() {
            return playerView;
        }
         ...
         * Player's view
         */
        public void setPlayerView(komus24.model.PlayerView value) {
        ...
        public GetOrder(komus24.model.PlayerView playerView, boolean debugAvailable) {
        ...
        public static GetOrder readFrom(java.io.InputStream stream) throws java.io.IOException {
            komus24.model.PlayerView playerView;
            playerView = komus24.model.PlayerView.readFrom(stream);
