...
public abstract class ClientMessage {
    ...
    public static class DebugMessage extends ClientMessage {
         ...
         * Command to perform
         */
        private komus24.debugging.DebugCommand command;
    
        /**
         * Command to perform
         */
        public komus24.debugging.DebugCommand getCommand() {
            return command;
        }
         ...
         * Command to perform
         */
        public void setCommand(komus24.debugging.DebugCommand value) {
            this.command = value;
        }
    
        public DebugMessage(komus24.debugging.DebugCommand command) {
        ...
        public static DebugMessage readFrom(java.io.InputStream stream) throws java.io.IOException {
            komus24.debugging.DebugCommand command;
            command = komus24.debugging.DebugCommand.readFrom(stream);
    ...
    public static class OrderMessage extends ClientMessage {
         ...
         * Player's order
         */
        private komus24.model.Order order;
    
        /**
         * Player's order
         */
        public komus24.model.Order getOrder() {
            return order;
        }
         ...
         * Player's order
         */
        public void setOrder(komus24.model.Order value) {
            this.order = value;
        }
    
        public OrderMessage(komus24.model.Order order) {
            this.order = order;
        }
        ...
        public static OrderMessage readFrom(java.io.InputStream stream) throws java.io.IOException {
            komus24.model.Order order;
            order = komus24.model.Order.readFrom(stream);
