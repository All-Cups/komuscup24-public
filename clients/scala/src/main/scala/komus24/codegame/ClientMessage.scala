...
object ClientMessage {
     ...
     */
    case class DebugMessage(command: komus24.debugging.DebugCommand) extends ClientMessage {
        /**
    ...
    object DebugMessage {
        ...
        def readFrom(stream: java.io.InputStream): DebugMessage = DebugMessage(
            komus24.debugging.DebugCommand.readFrom(stream)
        )
    }
     ...
     */
    case class OrderMessage(order: komus24.model.Order) extends ClientMessage {
        /**
    ...
    object OrderMessage {
        ...
        def readFrom(stream: java.io.InputStream): OrderMessage = OrderMessage(
            komus24.model.Order.readFrom(stream)
        )
    }
