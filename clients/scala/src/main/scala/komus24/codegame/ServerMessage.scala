...
object ServerMessage {
     ...
     */
    case class UpdateConstants(constants: komus24.model.Constants) extends ServerMessage {
        /**
    ...
    object UpdateConstants {
        ...
        def readFrom(stream: java.io.InputStream): UpdateConstants = UpdateConstants(
            komus24.model.Constants.readFrom(stream)
        )
    }
     ...
     */
    case class GetOrder(playerView: komus24.model.PlayerView, debugAvailable: Boolean) extends ServerMessage {
        /**
    ...
    object GetOrder {
        ...
        def readFrom(stream: java.io.InputStream): GetOrder = GetOrder(
            komus24.model.PlayerView.readFrom(stream),
