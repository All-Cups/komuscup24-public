namespace Komus24.Codegame
{
    ...
    public abstract class ClientMessage
    {
        ...
        public class DebugMessage : ClientMessage
        {
            ...
            /// Command to perform
            /// </summary>
            public Komus24.Debugging.DebugCommand Command { get; set; }
            ...
            public static new DebugMessage ReadFrom(System.IO.BinaryReader reader)
            {
                ...
                result.Command = Komus24.Debugging.DebugCommand.ReadFrom(reader);
                return result;
            }
        ...
        public class OrderMessage : ClientMessage
        {
            ...
            /// Player's order
            /// </summary>
            public Komus24.Model.Order Order { get; set; }
            ...
            public static new OrderMessage ReadFrom(System.IO.BinaryReader reader)
            {
                ...
                result.Order = Komus24.Model.Order.ReadFrom(reader);
                return result;
            }
