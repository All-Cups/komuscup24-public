namespace Komus24.Codegame
{
    ...
    public abstract class ServerMessage
    {
        ...
        public class UpdateConstants : ServerMessage
        {
            ...
            /// New constants
            /// </summary>
            public Komus24.Model.Constants Constants { get; set; }
            ...
            public static new UpdateConstants ReadFrom(System.IO.BinaryReader reader)
            {
                ...
                result.Constants = Komus24.Model.Constants.ReadFrom(reader);
                return result;
            }
        ...
        public class GetOrder : ServerMessage
        {
            ...
            /// Player's view
            /// </summary>
            public Komus24.Model.PlayerView PlayerView { get; set; }
            /// <summary>
            ...
            public GetOrder(Komus24.Model.PlayerView playerView, bool debugAvailable)
            {
            ...
            public static new GetOrder ReadFrom(System.IO.BinaryReader reader)
            {
                ...
                result.PlayerView = Komus24.Model.PlayerView.ReadFrom(reader);
