...
abstract class ClientMessage {
    ...
    class DebugMessage : ClientMessage {
         ...
         * Command to perform
         */
        var command: komus24.debugging.DebugCommand
    
        constructor(command: komus24.debugging.DebugCommand) {
    ...
    class OrderMessage : ClientMessage {
         ...
         * Player's order
         */
        var order: komus24.model.Order
    
        constructor(order: komus24.model.Order) {
            this.order = order
        }
