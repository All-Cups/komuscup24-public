...
abstract class ServerMessage {
    ...
    class UpdateConstants : ServerMessage {
         ...
         * New constants
         */
        var constants: komus24.model.Constants
    
        constructor(constants: komus24.model.Constants) {
    ...
    class GetOrder : ServerMessage {
         ...
         * Player's view
         */
        var playerView: komus24.model.PlayerView
        /**
         * Whether app is running with debug interface available
         */
        var debugAvailable: Boolean
    
        constructor(playerView: komus24.model.PlayerView, debugAvailable: Boolean) {
